---
title: "Figure 5 (male-specific variant) v6"
subtitle: "Main-figure panels bordered red; supplementary views unbordered with full descriptions. Pie-scatter promoted to (B'); log2 ratio bars moved to B-SUPP."
geometry: margin=1in
header-includes:
  - \usepackage{graphicx}
  - \usepackage{float}
