...
### 0 Define save path 
```{r}
plot.path.png <- "/Users/fkampf/Documents/pheromone.paper/analyses/strongest_path/plots/target.set.sensitivity/png/"
plot.path.pdf <- "/Users/fkampf/Documents/pheromone.paper/analyses/strongest_path/plots/target.set.sensitivity/pdf/"
```
...
p1<-ggplot(df_acc, aes(x = k, y = strength, color = modality)) +
  geom_line(size = 0.8) +
...
p2<-ggplot(df_acc_frac, aes(x = k, y = strength_frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~ dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
p3<-ggplot(df_acc_frac, aes(x = k, y = strength_frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
...
ggsave(file.path(plot.path.png,'absolute.path.strength.vs.k.facetted.by.pathway.png'),p1)
ggsave(file.path(plot.path.png,'fractional.path.strength.vs.k.facetted.by.pathway.png'),p2)
ggsave(file.path(plot.path.png,'fractional.path.strength.vs.k.facetted.by.pathway.with.stabilization.line.png'),p3)
p1
p2
p3
```
...
p1<-ggplot(df_acc.excitatory, aes(x = k, y = strength, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(x = "k", y = "Summed strength", title = "Excitatory – absolute strength")

p2<-ggplot(df_acc_frac.excitatory, aes(x = k, y = strength_frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
...
p3<-ggplot(df_acc_frac.excitatory, aes(x = k, y = strength_frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  geom_vline(xintercept = stabilization_point, linetype = "dashed", color = "red", size = 0.6) +
  theme_bw() +
...
ggsave(file.path(plot.path.png,'absolute.path.strength.excitatory.vs.k.facetted.by.pathway.png'),p1)
ggsave(file.path(plot.path.png,'fractional.path.strength.excitatory.vs.k.facetted.by.pathway.png'),p2)
ggsave(file.path(plot.path.png,'fractional.path.strength.excitatory.vs.k.facetted.by.pathway.with.stabilization.line.png'),p3)
p1
p2
p3
...
p1<-ggplot(df_acc.inhibitory, aes(x = k, y = strength, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(x = "k", y = "Summed strength", title = "Inhibitory – absolute strength")

p2<-ggplot(df_acc_frac.inhibitory, aes(x = k, y = strength_frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
...
p3<-ggplot(df_acc_frac.inhibitory, aes(x = k, y = strength_frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  geom_vline(xintercept = stabilization_point, linetype = "dashed", color = "red", size = 0.6) +
  theme_bw() +
...
ggsave(file.path(plot.path.png,'absolute.path.strength.inhibitory.vs.k.facetted.by.pathway.png'),p1)
ggsave(file.path(plot.path.png,'fractional.path.strength.inhibitory.vs.k.facetted.by.pathway.png'),p2)
ggsave(file.path(plot.path.png,'fractional.path.strength.inhibitory.vs.k.facetted.by.pathway.with.stabilization.line.png'),p3)
p1
p2
p3
```
...
p1<-ggplot(df_frac.excitatory.vs.inhibitory, aes(x = k, y = strength.delta.total, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
p2<-ggplot(df_frac.excitatory.vs.inhibitory, aes(x = k, y = cohens.d.total, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
p3<-ggplot(df_frac.excitatory.vs.inhibitory, aes(x = k, y = strength.delta.frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
p4<-ggplot(df_frac.excitatory.vs.inhibitory, aes(x = k, y = cohens.d.frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~dataset, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
ggsave(file.path(plot.path.png,'absolute.difference.between.valence.strength.vs.k.facetted.by.pathway.png'),p1)
ggsave(file.path(plot.path.png,'cohens.d.effect.size.between.valence.strength.vs.k.facetted.by.pathway.png'),p2)
ggsave(file.path(plot.path.png,'fractional.absolute.difference.between.valence.strength.vs.k.facetted.by.pathway.png'),p3)
ggsave(file.path(plot.path.png,'fractional.cohens.d.effect.size.between.valence.strength.vs.k.facetted.by.pathway.png'),p4)
p1
p2
p3
p4
...
p1<-ggplot(df_frac.PPN1.vs.vAB3.without.valence, aes(x = k, y = strength.delta.total, color = modality)) +
  geom_line(size = 0.8) +
  theme_bw() +
  labs(
    x = "k (top connections per start–end pair)",
...
# 2. Cohen’s d (absolute)
p2<-ggplot(df_frac.PPN1.vs.vAB3.without.valence, aes(x = k, y = cohens.d.total, color = modality)) +
  geom_line(size = 0.8) +
  theme_bw() +
  labs(
    x = "k (top connections per start–end pair)",
...
p3<-ggplot(df_frac.PPN1.vs.vAB3.without.valence, aes(x = k, y = strength.delta.frac, color = modality)) +
  geom_line(size = 0.8) +
  theme_bw() +
  labs(
    x = "k (top connections per start–end pair)",
...
# 4. Cohen’s d (fractional)
p4<-ggplot(df_frac.PPN1.vs.vAB3.without.valence, aes(x = k, y = cohens.d.frac, color = modality)) +
  geom_line(size = 0.8) +
  theme_bw() +
  labs(
    x = "k (top connections per start–end pair)",
...
p5<-ggplot(df_frac.PPN1.vs.vAB3.with.valence, aes(x = k, y = strength.delta.total, color = modality)) +
  geom_line(size = 0.8) +
...
p6<-ggplot(df_frac.PPN1.vs.vAB3.with.valence, aes(x = k, y = cohens.d.total, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~valence, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
p7<-ggplot(df_frac.PPN1.vs.vAB3.with.valence, aes(x = k, y = strength.delta.frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~valence, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
p8<-ggplot(df_frac.PPN1.vs.vAB3.with.valence, aes(x = k, y = cohens.d.frac, color = modality)) +
  geom_line(size = 0.8) +
  facet_wrap(~valence, ncol = 2, scales = "free_y") +
  theme_bw() +
  labs(
...
ggsave(file.path(plot.path.png,'absolute.difference.between.pathway.strength.vs.k.png'),p1)
ggsave(file.path(plot.path.png,'cohens.d.effect.size.between.payhway.strength.vs.k.png'),p2)
ggsave(file.path(plot.path.png,'fractional.absolute.difference.between.pathway.strength.vs.k.png'),p3)
ggsave(file.path(plot.path.png,'fractional.cohens.d.effect.size.between.payhway.strength.vs.k.png'),p4)
ggsave(file.path(plot.path.png,'absolute.difference.between.pathway.strength.vs.k.facetted.by.valence.png'),p5)
ggsave(file.path(plot.path.png,'cohens.d.effect.size.between.payhway.strength.vs.k.facetted.by.valence.png'),p6)
ggsave(file.path(plot.path.png,'fractional.absolute.difference.between.pathway.strength.vs.k.facetted.by.valence.png'),p7)
ggsave(file.path(plot.path.png,'fractional.cohens.d.effect.size.between.payhway.strength.vs.k.facetted.by.valence.png'),p8)
p1
p2
p3
p4
