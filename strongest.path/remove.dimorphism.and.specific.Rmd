...
### 0 Define save path 
```{r}
plot.path.png <- "/Users/fkampf/Documents/pheromone.paper/strongest.path/plots/remove.dimorphism.and.specific/png/"
plot.path.pdf <- "/Users/fkampf/Documents/pheromone.paper/strongest.path/plots/remove.dimorphism.and.specific/pdf/"
```
